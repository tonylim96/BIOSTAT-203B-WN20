...
# content of boxes
box_content <- matrix(nrow = num_of_boxes, ncol = 1, data = 0)
box_content[1] = "All patients in TRANSFER \n n = 261,897" # 1st box
box_content[2] = "Exclude patients if prev_careunit = NA or\n curr_careunit != CCU \n n = 254,245" # 2nd box
box_content[3] = "Exclude patients who aren't in neo_admissions \n n = 7,279" # 3rd box
