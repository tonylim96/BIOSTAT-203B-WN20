...
## Logistic regression
I included only `age`, `DRG severity`, and `gender` in the logistic regression. The other variables (principal diagnosis and ethnic group) did not appear to be statistically significant (p-values above 0.05).
```{r}
