...
The following [CONSORT Flow Diagrams](http://www.consort-statement.org/consort-statement/flow-diagram) plots the flow of data selection of the patient cohort. 
```{r plot, echo = FALSE}
library(shape)
library(diagram)
