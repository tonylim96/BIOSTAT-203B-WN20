...
MIMIC-III consists of a total of [40 tables](https://mit-lcp.github.io/mimic-schema-spy/index.html), but this report will only utilize:
...
## Logistic regression
```{r}
glm(mortality ~ age + drg_severity + principal_dx + gender + ethnic_group, data = study_admissions, 
