...
**Solution:** 
<p align="center">
  <img src="./completion_report.png" height="450" width="700">
...
**Solution:** The bash script is a `for` loop that only lists `csv` files. The output is
...
<!-- ```{bash} -->
<!-- for ((i = 10; i <= 14; i++)); do -->
<!--   awk -F',' '{print $i}' /home/203bdata/mimic-iii/ADMISSIONS.csv | sort | uniq -->
<!-- done -->
<!-- ``` -->

<!-- ```{bash} -->
<!-- for var in {INSURANCE}; -->
<!-- do  -->
<!--   awk -F',' '{print $var}' /home/203bdata/mimic-iii/ADMISSIONS.csv | sort | uniq -->
<!-- done; -->
<!-- ``` -->
...
If `test1.txt` does not exist, the first command would create the file that would contain "hello, world".  If `test1.txt1` already exists, the command would overwrite the file.
